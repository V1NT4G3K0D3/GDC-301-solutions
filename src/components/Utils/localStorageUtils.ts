...
export const templateMedicalFormFields: formField[] = [
  { label: "Name", id: 1, type: "text", value: "" },
  { label: "History", id: 2, type: "text", value: "" },
  { label: "Disease", id: 3, type: "email", value: "" },
  { label: "Treatment", id: 4, type: "date", value: "" },
  { label: "Phone number", id: 5, type: "number", value: "" },
  { label: "DOB", id: 6, type: "text", value: "" },
  { label: "Medical specialist", id: 7, type: "text", value: "" },
];

export const templateProductFormFields: formField[] = [
  { label: "Name", id: 1, type: "text", value: "" },
  { label: "Description", id: 2, type: "text", value: "" },
  { label: "Price", id: 3, type: "number", value: "" },
  { label: "Quantity", id: 4, type: "number", value: "" },
  { label: "Category", id: 5, type: "text", value: "" },
];

export const templateStudentFormFields: formField[] = [
  { label: "Name", id: 1, type: "text", value: "" },
  { label: "Course", id: 2, type: "text", value: "" },
  { label: "Email", id: 3, type: "email", value: "" },
  { label: "Stream", id: 4, type: "date", value: "" },
  { label: "Phone number", id: 5, type: "number", value: "" },
  { label: "Address", id: 6, type: "text", value: "" },
];
