...
// type OptionActions = AddOptionAction | RemoveOptionAction;

// const reducer = (state: string[], action: OptionActions) => {
//   switch (action.type) {
//     case "add_option": {
...
//   const dispatchAction = (action: OptionActions) => {
//     setOptions(() => reducer(options, action));
...
//                     onClick={() =>
//                       dispatchAction({ type: "add_option", newOption })
//                     }
//                   >
//                     Add Option
//                   </button>
...
//                         onClick={(_) =>
//                           dispatchAction({ type: "remove_option", option })
//                         }
//                       >
//                         X
//                       </button>
...
function OptionsFieldModal() {
  return <div>OptionsFieldModal</div>;
}

export default OptionsFieldModal;
